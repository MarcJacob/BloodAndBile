...
public class Console : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                Disable(); // Par défaut la console est désactivée.
            }
        }
    }
    ...
    public void DisplayHelp(object[] parameters)
    {
        ...
        WriteLine("'SetAccountCredentials <Pseudo> <Mot de passe>' - Change les informations de compte de ce client.", helpColor);
        WriteLine("'ConnectToMasterServer [<Pseudo> <Mot de passe>]' - Lance une tentative de connexion au Master Server.", helpColor);
        WriteLine("'CreateMatch <Nom du match> [<Mot de passe>]' - Crée un match et le signale au Master Server.", helpColor);
        WriteLine("'ConnectToMatch <IP> <Port> [<Mot de passe>]' - Tente une connexion au match à l'IP et Port donnés.", helpColor);
    }
}